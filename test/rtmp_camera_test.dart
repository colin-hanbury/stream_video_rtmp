...
void main() {
  final StreamVideoRtmpPlatform initialPlatform =
      StreamVideoRtmpPlatform.instance;

  test('$MethodChannelRtmpCamera is the default instance', () {
    expect(initialPlatform, isInstanceOf<MethodChannelRtmpCamera>());
  });
